...
@Component({
  selector: 'app-section-one-thru-work',
  templateUrl: './section-one-thru-work.component.html',
  styleUrls: ['./section-one-thru-work.component.css']
})
export class SectionOneThruWorkComponent implements OnInit {
